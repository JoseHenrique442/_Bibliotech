...
<body>
    ...
    <main id="home">
        ...
        <div class="bibliotech__collection" style="margin-top: -90rem;"> 
            <div class="content__swiper">
                <h1 class="swiper__title">Resultados</h1>
                <div class="swiper mySwiper">
                    ...
                    <?php
                        ...
                        $nome = mysqli_real_escape_string($conexao, trim($_GET['livro']));
                        
                        $query = ("SELECT TITULO_OBRA from obras where TITULO_OBRA LIKE '%$nome%'");
                        $sql_query = mysqli_query($conexao, $query);
                        $query = "SELECT * from obras where TITULO_OBRA LIKE '%$nome%'";
                         $queryy = "SELECT * from obras where TITULO_OBRA LIKE '%$nome%' ";
