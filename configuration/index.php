...
<head>
    ...
    <title>Página de Configurações | Bibliotech</title>
</head>
<body>
    <!-- MENU LATERAL -->
    <nav>
    ...
    <main id="home">
        ...
        <div class="container__config">
            <form action="configuration.php" method="POST">
                <div class="profile__info" id="title">
                    <h1 class="config__title" id="top__page__title">Configurações de Perfil</h1>                          
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">Nome Completo</h2>
                    <input type="text" name="NOME" class="inputChange" readoly value="<?php print_r($_SESSION['NOME']);?>">
                </div>
                <!--<div class="profile__info" id="password__input">
                    <h2 class="wrapper__info">Senha</h2>
                    <input type="password" id="password" name=" " class="inputChange" readonly value="Altere sua senha">
                ...
                <div class="profile__info">
                    <h2 class="wrapper__info">Número de Matrícula</h2>
                    <input type="text" name="MATRICULA" readoly value=" <?php print_r($_SESSION['MATRICULA']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">CPF</h2>
                    <input type="text" name="CPF" readonly value=" <?php print_r($_SESSION['CPF']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">E-mail Institucional</h2>
                    <input type="text" name="EMAIL" class="inputChange" value=" <?php print_r($_SESSION['EMAIL']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">Curso</h2>
                    <input type="text" name="CURSO" readonly value=" <?php print_r($_SESSION['CURSO']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">Categoria de Usuário</h2>
                    <input type="text" name="TIPOUS" readonly value=" <?php print_r($_SESSION['TIPO']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">Vínculo</h2>
                    <input type="text" name="CAMPUS" readonly value=" <?php print_r($_SESSION['CAMPUS']);?>">
                </div>
                <div class="profile__info">
                    <h2 class="wrapper__info">Situação</h2>
                    <input type="text" name="SITUACAO" readonly value=" <?php print_r($_SESSION['SITUACAO']);?>">
                </div>
                <div class="buttons">
                    <button class="btn" id="salvar">Salvar</button>
                    <div class="btn" id="alterar"><a href="#top__page__title" style="text-decoration: none; color: var(--fundoPreto);">Alterar</a></div>
                </div>
            </form>
        </div>
    </main>
    ...
    <script>
        ...
        btnAlterar.addEventListener('click', ()=> {
            ...
            inputChange.forEach(i => {
                i.removeAttribute('readonly');
                i.style.borderBottom = 'solid .4rem var(--complementar2)';
                i.select();
            });
