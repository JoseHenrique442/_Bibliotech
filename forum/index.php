...
<body>
    ...
    <main id="home">
        ...
        <div class="forum__content">
            <h1 class="forum__title">Fórum</h1>
            <div class="forum__wrapper">
                <span class="topic__status">Status</span>
                <span class="topic__name">Tópico</span>
                <span class="topic__autor">Autor</span>
                <span class="topic__data">Data</span>
                <div class="forum__topic">
                    <!-- STATUS DO TÓPICO (RESPONDIDO OU NÃO) -->
                    <div class="status">
                        <!-- SVG PARA TÓPICO APROVADO/RESPONDIDO -->
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_106_75)">
                            <path d="M0 25C0 11.1914 11.1914 0 25 0C38.8086 0 50 11.1914 50 25C50 38.8086 38.8086 50 25 50C11.1914 50 0 38.8086 0 25ZM36.3086 20.6836C37.373 19.6191 37.373 17.8809 36.3086 16.8164C35.2441 15.752 33.5059 15.752 32.4414 16.8164L21.875 27.3828L17.5586 23.0664C16.4941 22.002 14.7559 22.002 13.6914 23.0664C12.627 24.1309 12.627 25.8691 13.6914 26.9336L19.9414 33.1836C21.0059 34.248 22.7441 34.248 23.8086 33.1836L36.3086 20.6836Z" fill="black"/>
                            </g>
                            <defs>
                    ...
                    <!-- TÍTULO DO TÓPICO -->
                    <div class="name">
                        <a href="./topic-page.php">
                            <h1>Porque "O Amor de Pedro por João"?</h1>
                        </a>
                    </div>
                    <!-- AUTOR DO TÓPICO -->
                    <div class="autor__img">
                        <a href="../perfil/index.php">
                            <img src="../img/user-1.jpg" alt="FOTO DO AUTOR">
                        </a>
                    </div>
                    <!-- DATA DO TÓPICO -->
                    <div class="data">
                ...
                <div class="forum__topic">
                    <div class="status">
                        <!-- SVG PARA TÓPICO NÃO APROVADO/RESPONDIDO -->
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M25 0C11.1914 0 0 11.1914 0 25C0 38.8086 11.1914 50 25 50C38.8086 50 50 38.8086 50 25C50 11.1914 38.8086 0 25 0ZM22.6562 14.8438C22.6562 13.5547 23.7109 12.5 25 12.5C26.2891 12.5 27.3438 13.5498 27.3438 14.8438V27.3438C27.3438 28.6377 26.2939 29.6875 25 29.6875C23.7061 29.6875 22.6562 28.6426 22.6562 27.3438V14.8438ZM25 39.0625C23.3047 39.0625 21.9297 37.6875 21.9297 35.9922C21.9297 34.2969 23.3037 32.9219 25 32.9219C26.6963 32.9219 28.0703 34.2969 28.0703 35.9922C28.0664 37.6855 26.6992 39.0625 25 39.0625Z" fill="black"/>
                        </svg>    
                    </div>
                    <div class="name">
                    ...
                    <div class="autor__img">
                        <img src="../img/user-2.jpg" alt="FOTO DO AUTOR">
                    </div>
                    <div class="data">
                ...
                <div class="forum__topic">
                    ...
                    <div class="autor__img">
                        <img src="../img/user-3.jpg" alt="FOTO DO AUTOR">
                    </div>
                    <div class="data">
                ...
                <div class="forum__topic">
                    ...
                    <div class="autor__img">
                        <img src="../img/user-4.jpg" alt="FOTO DO AUTOR">
                    </div>
                    <div class="data">
                ...
                <div class="forum__topic">
                    ...
                    <div class="autor__img">
                        <img src="../img/user-5.jpg" alt="FOTO DO AUTOR">
                    </div>
                    <div class="data">
                ...
                <div class="forum__topic">
                    ...
                    <div class="autor__img">
                        <img src="../img/user-6.jpg" alt="FOTO DO AUTOR">
                    </div>
                    <div class="data">
