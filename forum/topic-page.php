...
<head>
    ...
    <title>Página do Tópico | Bibliotech</title>
</head>
<body>
    <!-- MENU LATERAL -->
    <nav>
    ...
    <main id="home">
        ...
        <div class="forum__content">
            <h1 class="forum__title">Título do tópico</h1>
            <div class="topic__wrapper">
                <span>(Nome do autor) Escreveu:</span>
                <p>Lorem, ipsum dolor sit ametLorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas obcaecati quod repudiandae dignissimos praesentium ea, fugit laboriosam deleniti consectetur laudantium libero quo. Vitae officia recusandae molestias fuga ullam assumenda quae. consectetur adipisicing elit. Voluptas obcaecati quod repudiandae dignissimos praesentium ea, fugit laboriosam deleniti consectetur laudantium libero quo. Vitae officia recusandae molestias fuga ullam assumenda quae.Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas obcaecati quod repudiandae dignissimos praesentium ea, fugit laboriosam deleniti consectetur laudantium libero quo. Vitae officia recusandae molestias fuga ullam assumenda quae.Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas obcaecati quod repudiandae dignissimos praesentium ea, fugit laboriosam deleniti consectetur laudantium libero quo. Vitae officia recusandae molestias fuga ullam assumenda quae.Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas obcaecati quod repudiandae dignissimos praesentium ea, fugit laboriosam deleniti consectetur laudantium libero quo. Vitae officia recusandae molestias fuga ullam assumenda quae.</p>    
            </div>
            <form action="">
                <h1>Comentários</h1>
                <div class="comment__box">
                    ...
                    <div class="comment__input">
                        <textarea name="" id="" maxlength="500" required></textarea>
                    </div>
                </div>
            ...
            <div class="comment__box">
                ...
                <div class="comment__input">
                    <textarea value='' name="" id="" maxlength="500" required readonly>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est delectus, accusantium quod voluptate distinctio nesciunt consequuntur blanditiis mollitia quo magni eveniet nihil libero eius error necessitatibus sed. Magni, minima exercitationem?
                    </textarea>
                </div>
            </div>
            <!--  COMENTÁRIO 2 -->
            <div class="comment__box">
                <div class="user__img">
                    <img src="../img/user-6.jpg" alt="FOTO DE PERFIL">
                </div>
                <div class="comment__input">
                    <textarea value='' name="" id="" maxlength="500" required readonly>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est delectus, accusantium quod voluptate distinctio nesciunt consequuntur blanditiis mollitia quo magni eveniet nihil libero eius error necessitatibus sed. Magni, minima exercitationem?
                    </textarea>
