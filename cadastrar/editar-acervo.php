...
<body>
    ...
    <main id="home">
        ...
        <div class="container">
            <h1 class="title">Editar acervo</h1>
            <form action="./exclui.php" method="POST">
            <div class="inputs">    
                    <label for="">Qual acervo você quer excluir?</label>
                    <input type="select" name="ACERVO" id="" placeholder="Escreva o nome das opções abaixo:">
                    <select name="NOME" id="">
                    <?php 
                            include('../conexao.php');
                ...
                <div class="buttons">
                    <button class="btn" name="ex" value="edia">Editar</button>  
                    <button class="btn" name="ex" value="acervo">Excluir</button>
                </div>
            </form>
        </div>
    </main>
