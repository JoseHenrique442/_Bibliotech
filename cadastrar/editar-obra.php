...
<body>
    ...
    <main id="home">
        ...
        <div class="container">
            <h1 class="title">Editar cadastro de obra</h1>
            <form action="./exclui.php" method="POST">
            <div class="input__box">
                    <label for="">Qual livro você quer editar?</label>
                    <input type="select" name="TITULO_OBRA" id="" placeholder="Escreva o título das opções a seguir:">
                    ...
                    <?php 
                            ...
                            while($row = mysqli_fetch_assoc($sql)){
                                echo "<option>".$row['TITULO_OBRA']."</option>";
                ...
                <div class="buttons">
                <button class="btn" name="ex" value="edio">Editar</button>       
                    <button class="btn" name="ex" value="obra">Excluir</button>       
                </div>
            </form>
        </div>
    </main>
