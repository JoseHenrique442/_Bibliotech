...
<head>
    ...
    <link rel="stylesheet" href="./obra.css" type="text/css">
    <link rel="stylesheet" href="../global.css" type="text/css">
    <title>Cadastro de Obra | Bibliotech</title>
</head>
<body>
    <!-- MENU LATERAL -->
    <nav>
    ...
    <main id="home">
        ...
        <div class="container">
            <h1 class="title">Cadastro de obra</h1>
            <form action="./edi.php" method="POST" enctype="multipart/form-data">
                <!-- INPUT 1 (SELECT)--><?php
             
                echo '<div class ="input_box" hidden >
                <input type="text" name="'.$_SESSION['book'].'" $value="'.$_SESSION['book'].'" hidden>
            </div>';
            ?>
                <div class="input__box">
                    <label for="">Acervo Pertencente</label>
                    <select name="TIPO" id="">
                    <?php 
                            include('../conexao.php');

                            $sql = mysqli_query($conexao, "Select NOME from acervo");
                ...
                <!-- INPUT 2 -->
                <div class="input__box">
                    <label for="">Número de série ISBN</label>
                    <input type="text" name="NUM_SERIE" id="">
                </div>
                <!-- INPUT 3 -->
                <div class="input__box medium">
                    <label for="">Autores</label>
                    <textarea name="AUTORES" id=""></textarea>
                </div>
                <!-- INPUT 4 -->
                <div class="input__box medium">
                    <label for="">Tradutores</label>
                    <textarea name="TRADUTORES" id=""></textarea>
                </div>
                <!-- INPUT 5 -->
                <div class="input__box">
                    <label for="">Título da obra</label>
                    <input type="text" name="TITULO_OBRA" id="">
                </div>
                <!-- INPUT 6 -->
                <div class="input__box">
                    <label for="">Subtítulo da obra</label>
                    <input type="text" name="SUBTITU_OBRA" id="">
                </div>
                <!-- INPUT 7 (SELECT)-->
                <div class="input__box">
                    <label for="">Gênero</label>
                    <select name="GENERO" id="">
                        <option value="Classicos" selected>1- Clássicos</option>
                        <option value="Drama">2 - Drama</option>
                        <option value="Novela">3 - Novela</option>
                        <option value="Romance">4 - Romance</option>
                        <option value="Misterio">5 - Mistério</option>
                        <option value="Ficcao">6 - Ficção</option>
                        <option value="Aventura">7 - Aventura</option>
                        <option value="Biografia">8 - Biografia</option>
                        <option value="Colecao">9 - Coleção</option>
                        <option value="Cientifico">10 - Científico</option>
                        <option value="Humor">11 - Humor</option>
                        <option value="AutoAjuda">12 - Auto Ajuda</option>
                        <option value="Academico">13 - Acadêmico</option>
                        <option value="Conto">14 - Conto</option>
                        <option value="Poesia">15 - Poesia</option>
                        <option value="E-Books">16 - E-Books</option>
                    </select>
                </div>
                <!-- INPUT 8 -->
                <div class="input__box">
                    <label for="">Edição</label>
                    <input type="text" name="EDICAO" id="">
                </div>    
                <!-- INPUT 9 (number)-->
                <div class="input__box">
                    <label for="">Ano de publicação</label>
                    <input type="date" name="ANO_PUBLI" id="">
                </div>
                <!-- INPUT 10 -->
                <div class="input__box">
                    <label for="">Lugar de publicação</label>
                    <input type="text" name="LUGAR_PUBLI" id="">
                </div>
                <!-- INPUT 11 (SELECT)-->
                <div class="input__box">
                    <label for="">Biblioteca a que pertence</label>
                    <select name="BIBLIO_PERTE" id="">
                        <option value="IFFar-FW" selected>1- Biblioteca IFFar-FW</option>
                    </select>
                </div>
                <!-- INPUT 12 -->
                <div class="input__box">
                    <label for="">Descrição física</label>
                    <input type="text" name="DESCR_FISICA" id="">
                </div>
                <!-- INPUT 13 -->
                <div class="input__box">
                    <label for="">Espaço para a classificação</label>
                    <input type="text" name="CLASSI" id="">
                </div>
                <!-- INPUT 14 (TEXTAREA)-->
                <div class="input__box large">
                    <label for="">Espaço para resumo da obra</label>
                    <textarea name="RESUMO" id=""></textarea>
                </div>
                <!-- INPUT 15 -->
                <div class="input__box">
                    <label for="">Palavras chave</label>
                    <input type="text" name="PALAV_CHAVE" id="">
                </div>
                <!-- INPUT 16 (UPLOAD DE IMG)-->
                <div class="input__box">
                    <label for="">Disponibilidade da capa do livro</label>
                    <input type="file" name="CAPA_LIVRO" id="imagem__capa">
                </div> 
                <!-- INPUT 17 -->
                <div class="input__box">
                    <label for="">Link eletrônico da obra</label>
                    <input type="text" name="LINK_ELETRO" id="">
                </div>
                <!-- INPUT 18 -->
                <div class="input__box">
                    <label for="">Link eletrônico do E-Book</label>
                    <input type="text" name="LINK_EBOOK" id="">
                </div>
                <!-- INPUT 19 -->
                <div class="input__box">
                    <label for="">Número do livro</label>
                    <input type="text" name="NUM_LIVRO" id="">
                </div>   
                <div class="buttons">                                 
                    <button class="btn" name="butun" value="Editar">Editar</button>             
                </div>           
            </form>
        </div>
    </main>
