...
<body>
    ...
    <main id="home">
        ...
        <div class="container">
            ...
            <form action="cad_obra.php" method="POST" enctype="multipart/form-data">
                <!-- INPUT 1 (SELECT)-->
                ...
                <div class="buttons">                     
                    <button class="btn" name="butun" value="Exclui">Editar</button>             
                    <button class="btn" name="butun" value="Enviar">Enviar</button>             
                </div>           
            </form>
        </div>
    </main>
