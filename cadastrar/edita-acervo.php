...
<head>
    ...
    <link rel="stylesheet" href="./acervo.css" type="text/css">
    <link rel="stylesheet" href="../global.css" type="text/css">
    <title>Cadastro de Acervo | Bibliotech</title>
</head>
<body>
    <!-- MENU LATERAL -->
    <nav>
    ...
    <main id="home">
        ...
        <div class="container">
       <?php echo '<div class ="input_box" hidden >
                <input type="text" name="'.$_SESSION['acervo'].'" $value="'.$_SESSION['acervo'].'" hidden>
            </div>';?>
            <h1 class="title">Cadastro de acervo</h1>
            <form action="./edia.php" method="POST">
                <div class="inputs">    
                    <label for="">Código do acervo</label>
                    <input type="number" name="COD" id="COD">
                </div>
                <div class="inputs">
                    <label for="">Tipo de Acervo</label>
                    <select name="TIPO" id="TIPO">
                        <option value="Livro" selected>1- Livros</option>
                        <option value="Folheto">2- Folhetos</option>
                        <option value="Catalogo">3 - Catálogo</option>
                        <option value="Artigo">4 - Artigos</option>
                        <option value="Software">5 - Software</option>
                        <option value="Dissertacao">6 - Dissertações</option>
                        <option value="Monografia">7 - Monografia</option>
                        <option value="Graduacao">8 - TCC - Graduação</option>
                        <option value="Norma">9 - Normas</option>
                    </select>
                </div>
                <div class="inputs large">
                    <label for="">Classificação CDU</label>
                    <textarea name="CLAS" id="CLAS" maxlength="250"></textarea>
                </div>
                <div class="buttons">         
                    <button class="btn" name="butun" value="Editar">Enviar</button>     
                </div>
            </form>
        </div>
    </main>
