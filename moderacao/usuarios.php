...
<head>
    ...
    <title>Moderação de Usuários | Bibliotech</title>
</head>
<body>
    <!-- MENU LATERAL -->
    <nav>
    ...
    <main id="home">
        ...
        <div class="container">
            <h1 class="title">Moderação de Usuários</h1>
            <div class="users__wrapper">
                <span class="nome">Nome</span>
                <span class="funcao">Função</span>
                <span class="salvar">Salvar</span>
                <div class="user__content">
                    <form action="atri.php" method="POST">
                        <h2><select name="NOME" id="NOME">
                            <option selected></option>
                            <?php 
                            include('../conexao.php');

                            $sql = mysqli_query($conexao, "Select NOME from usuarios where PERM <= 1");
                        ...
                        <button>
                            <svg width="51" height="52" viewBox="0 0 51 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.28571 0.625C3.26719 0.625 0 3.87617 0 7.875V44.125C0 48.1238 3.26719 51.375 7.28571 51.375H43.7143C47.7328 51.375 51 48.1238 51 44.125V16.6316C51 14.7059 50.2373 12.8594 48.8712 11.5L40.0714 2.74336C38.7054 1.38398 36.8498 0.625 34.9145 0.625H7.28571ZM7.28571 11.5C7.28571 9.49492 8.91362 7.875 10.9286 7.875H32.7857C34.8007 7.875 36.4286 9.49492 36.4286 11.5V18.75C36.4286 20.7551 34.8007 22.375 32.7857 22.375H10.9286C8.91362 22.375 7.28571 20.7551 7.28571 18.75V11.5ZM25.5 44.125C21.4815 44.125 18.2143 40.8738 18.2143 36.875C18.2143 32.8762 21.4815 29.625 25.5 29.625C29.5185 29.625 32.7857 32.8762 32.7857 36.875C32.7857 40.8738 29.5185 44.125 25.5 44.125Z" fill="black"/>
                            </svg>    
                        </button>
                    </form>
                </div>
