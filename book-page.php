...
include('./login/verificar.php');
 ...
 $_SESSION['url'] = substr($_SERVER["REQUEST_URI"], strpos($_SERVER["REQUEST_URI"], '/'));
...
<body>
    ...
    <main id="home">
        ...
        $livro = parse_url($url, PHP_URL_QUERY);
    ...
    $sql = mysqli_query($conexao, "SELECT RESUMO from obras where TITULO_OBRA = '$livro'");
    $sqls = mysqli_query($conexao, "SELECT DESCRICAO from comentarios where APROVADO = true and TITULO_OBRA = '$livro'");
    $_SESSION['TITULO_OBRA'] = $livro;

    $query = "SELECT * from obras where TITULO_OBRA = '{$livro}'";
    $queryy = "SELECT * from obras where TITULO_OBRA = '{$livro}'";
   ...
   $aaa = mysqli_query($conexao, $queryy);   
        ...
        echo '<div class="content">
            <div class="book__info">
                ...
                <img src="./cadastrar/imagens/'.$dadoss['idobras'].'/'.$dados['CAPA_LIVRO'].'">
                </div>
                <div class="info">
                    <h1>'.$livro.'</h1>
                    <h2>Resumo</h2>
                    ...
                    <div class="share">
                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M47.1429 26.25C54.2411 26.25 60 21.2109 60 15C60 8.78906 54.2411 3.75 47.1429 3.75C40.0446 3.75 34.2857 8.78906 34.2857 15C34.2857 15.4688 34.3125 15.9375 34.3795 16.3945L21.7768 21.9023C19.4732 19.9453 16.3259 18.75 12.8571 18.75C5.75893 18.75 0 23.7891 0 30C0 36.2109 5.75893 41.25 12.8571 41.25C16.3259 41.25 19.4732 40.0547 21.7768 38.0977L34.3795 43.6055C34.3125 44.0625 34.2857 44.5195 34.2857 45C34.2857 51.2109 40.0446 56.25 47.1429 56.25C54.2411 56.25 60 51.2109 60 45C60 38.7891 54.2411 33.75 47.1429 33.75C43.6741 33.75 40.5268 34.9453 38.2232 36.9023L25.6205 31.3945C25.6875 30.9375 25.7143 30.4805 25.7143 30C25.7143 29.5195 25.6875 29.0625 25.6205 28.6055L38.2232 23.0977C40.5268 25.0547 43.6741 26.25 47.1429 26.25Z" fill="#161925"/>
                        </svg> 
                        <a>Compartilhar obra</a>
                        <p class="copied">copiado!</p>
                    </div>
                </div>
            </div>  
            <div class="rating">
                <h1>Avalie esse livro!</h1>
                ...
                <h2>Não esqueça de deixar a sua opinião aqui em baixo!</h2>
            </div>
            <div class="comment">
                <h1>Comentários</h1>
                <!-- COMENTAR -->
                <form action="cad_comen.php" method="POST">
                    <div class="comment__box">
                        <div class="user__img">
                            <img src="./img/user-4.jpg" alt="FOTO DE PERFIL">
                        </div>
                        <div class="comment__input">
                            <textarea name="TEXTO" placeholder="Deixe seu comentário aqui!" id="" maxlength="500" required></textarea>
                        </div>
                    </div>
            ...
            $b = 0;
                ...
                $b++;
               echo ' <!-- COMENTARIO 1 -->
               <form action="excloi.php" method="POST">
                <div class="comment__box">
                    <div class="user__img">
                        <img src="./img/user-5.jpg" alt="FOTO DE PERFIL">
                    </div>
                    <div class="comment__input">
                        <textarea value="'.$rows['DESCRICAO'].'" name="comen" id="" maxlength="500" required readonly>'.$rows['DESCRICAO'].'
                        </textarea>
    ...
    <script>
        ...
        let link = document.querySelector('.share');
        let copied = document.querySelector('.copied');
        // REINICIA O TEXTAREA PARA COMENTAR
        textarea.value = ''; 
        // LINK PARA COMPARTILHAR LIVRO        
    ...
    <script src="https://kit.fontawesome.com/0647539439.js" crossorigin="anonymous"></script>
</body>
</html>