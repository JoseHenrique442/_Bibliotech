...
<head>
    ...
    <link rel="stylesheet" href="./recover.css" type="text/css">
    ...
    <main id="home">
        ...
        <div class="container">
            ...
            <div class="recover__steps">
                <p>Esqueceu ou perdeu a senha? Fique tranquilo! Vamos te ajudar a recuperar a sua conta</p>
                <br>
                <p><span class="bold">Passo 1:</span> Digite seu e-mail no campo abaixo</p>
                <p><span class="bold">Passo 2:</span> Você reberá instruções em seu e-mail para prosseguir com a recuperação da conta</p>
            </div>
            <form action="">
                <input type="email" name="" id="" required placeholder="fuleco@copa2014.com">
                <div class="btn">
                    <span id="border"></span>
                    <span class="bg"></span>
